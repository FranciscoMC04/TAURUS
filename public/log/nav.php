  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="/TAURUS/public/index.php" class="flex ms-2 md:me-24">
          <!-- <img src="../img/buslogin.jpg" class="h-8 me-3" alt="UNIVERSIDAD Logo" /> -->
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">TAURUS</span>
        </a>
      </div>
