    ...
    <div class="flex">
        ...
        <div class="ml-64 w-full pt-16 p-6 mt-6">
            <div class="mt-6 text-white">
                <h1 class="text-2xl font-bold mb-4">Fichas</h1>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th class="px-6 py-3">Planificador ID</th>
                                <th class="px-6 py-3">Guía ID</th>
                            ...
                            <?php if (count($fichas) > 0): ?>
                                <?php foreach ($fichas as $ficha): ?>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            <?= htmlspecialchars($ficha['fecha_inicio']) ?>
                                        </td>
                                        <td class="px-6 py-4">
                                            <?= htmlspecialchars($ficha['fecha_fin']) ?>
                                        </td>
                                        <td class="px-6 py-4">
                                            <?= htmlspecialchars($ficha['planificador_id']) ?>
                                        </td>
                                        <td class="px-6 py-4">
                                            <?= htmlspecialchars($ficha['guia_id']) ?>
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <a href="edit.php?id=<?= $ficha['id'] ?>"
                                               class="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-3">
                                                <i class="fas fa-edit"></i> Editar
                                            </a>
                                            <a href="delete.php?id=<?= $ficha['id'] ?>"
                                               onclick="return confirm('¿Eliminar la ficha #<?= $ficha['id'] ?>?')"
