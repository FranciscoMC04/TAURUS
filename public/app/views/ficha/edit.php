...
$stmt = $conexion->prepare("SELECT * FROM ficha WHERE id = ?");
        ...
        <form method="post" action="../../models/ficha.php"
          ...
          <div class="mb-4">
            ...
            <input type="text" id="codigo" name="codigo"
                   value="<?= htmlspecialchars($ficha['codigo']) ?>"
          ...
          <div class="mb-4">
            ...
            <input type="text" id="titulo" name="titulo"
                   value="<?= htmlspecialchars($ficha['titulo']) ?>"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                          focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700" required />
          </div>
          ...
          <div class="mb-4">
            ...
            <textarea id="descripcion" name="descripcion" rows="3"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                             focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700" required><?= htmlspecialchars($ficha['descripcion']) ?></textarea>
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="number" id="planificador_id" name="planificador_id"
                   value="<?= htmlspecialchars($ficha['planificador_id']) ?>"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                          focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700" required />
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="number" id="guia_id" name="guia_id"
                   value="<?= htmlspecialchars($ficha['guia_id']) ?>"
                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                          focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700" required />
          </div>
          ...
          <div class="mb-4">
            ...
            <select id="estado" name="estado"
              ...
              <option value="publicado" <?= $ficha['estado'] === 'publicado' ? 'selected' : '' ?>>Publicado</option>
              <option value="borrador" <?= $ficha['estado'] === 'borrador' ? 'selected' : '' ?>>Borrador</option>
            </select>
          </div>
