...
$restaurante = $restauranteObj->show($_GET['id']);
?>
      ...
      <div class="flex-grow flex items-center justify-center">
        ...
        <form method="POST" action="../../models/restaurante.php"
          ...
          <div class="mb-4">
            ...
            <input type="text" name="direccion" value="<?= $restaurante['direccion'] ?>"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                     focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                     dark:bg-gray-700 dark:border-gray-600 dark:text-white">
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="text" name="tipo_comida" value="<?= $restaurante['tipo_comida'] ?>"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                     focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                     dark:bg-gray-700 dark:border-gray-600 dark:text-white">
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="number" name="capacidad" value="<?= $restaurante['capacidad'] ?>"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                     focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                     dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              required>
